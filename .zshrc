...
plugins=( git node npm osx autojump zsh-completions zsh-autosuggestions zsh-syntax-highlighting aws docker docker-compose docker-machine
)
...
# Enable autojmp for zsh from fish
