...
"Plug 'ncm2/ncm2-jedi' " i would like to challenge mmy macbook pro
"Plug 'ncm2/ncm2-bufword'  " buffer keyword completion
"Plug 'ncm2/ncm2-path'  " filepath completion
Plug 'spinks/vim-leader-guide' " show global keymap in popup
" On-demand lazy load
Plug 'liuchengxu/vim-which-key', { 'on': ['WhichKey', 'WhichKey!'] } " which-key displays available keybindings in popup
call plug#end()
